...
REM echo.
set SOURCE_LIB=kbdlayoutmonhook.cpp
...
cl /nologo /EHsc /DUNICODE /D_UNICODE /W4 /MD %SOURCE_EXE% %OUTPUT_RES_ICO% %OUTPUT_RES_VER% /link /out:%OUTPUT_DIR%\%OUTPUT_EXE% shlwapi.lib user32.lib gdi32.lib ole32.lib advapi32.lib shell32.lib 2>&1 >nul
if errorlevel 1 (
